...
def create_app(test_config=None):
    ...
    def quiz_game():
      ...
      try:    
        ...
        #if category 'all' selected then get all questions that weren't previous questions
        ...
        #get category quqstions that weren't in previous questions  
          ...
          questions = Question.query.filter_by(category=quiz_category['id']).filter(~Question.id.in_(prev_questions)).all()
