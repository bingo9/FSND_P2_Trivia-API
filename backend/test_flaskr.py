...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_delete_question(self):
        ...
        #Get num of quetsions after delete and query to make sure question deleted
    ...
    def test_create_question(self):
        ...
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertEqual(len(Question.query.all()), num_of_questions_before+1)
    ...
    def test_quiz_game(self):
        #play quiz
        res = self.client().post('/quizzes', json={'previous_questions':[5, 6],
